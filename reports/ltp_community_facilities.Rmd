...
facilities <- readRDS(fs::dir_ls(here::here("data"), glob = "*.rds")) |> filter(local_board != "Great Barrier")

ltp_metric_lb <- facilities |> 
  count(local_board, delivery_model) |> 
...
choose_facilities(chosen_lb) |> build_block_visual()
```
